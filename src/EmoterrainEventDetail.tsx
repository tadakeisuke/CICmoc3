...
const EmoterrainEventDetail = () => {
  ...
  const experience = {
    ...
    category: 'dance',
    // TODO: GitHub Pages用に画像をダウンロードし、ローカルパスに修正する必要があります。
    // thumbnail: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=450&fit=crop',
    thumbnail: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=450&fit=crop', // 仮表示用のURL
    // TODO: GitHub Pages用に動画をダウンロードし、ローカルパスに修正する必要があります。
